    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-6xl overflow-y-auto max-h-[95vh] p-4">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <img
              src='/src/assets/HomeImg/Aari.jpg'
              alt="Stitching Model"
      ...
      <form className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
        ...
        <div>
          ...
          <input type="text" placeholder="Priya" className="w-full border rounded-md px-3 py-2" />
        </div>
        <div>
          <label className="font-semibold mb-1 block">Mobile Number</label>
          <input type="text" placeholder="Enter your mobile number" className="w-full border rounded-md px-3 py-2" />
        </div>

        {/* Row 2 */}
        <div>
          <label className="font-semibold mb-1 block">Address</label>
          <input type="text" placeholder="Street Address" className="w-full border rounded-md px-3 py-2" />
        </div>
        <div>
          <label className="font-semibold mb-1 block">City</label>
          <input type="text" placeholder="Enter your city" className="w-full border rounded-md px-3 py-2" />
        </div>

        {/* Row 3 */}
        <div>
          <label className="font-semibold mb-1 block">State</label>
          <input type="text" placeholder="Enter your state" className="w-full border rounded-md px-3 py-2" />
        </div>
        <div>
          <label className="font-semibold mb-1 block">Pincode</label>
          <input type="text" placeholder="Enter your pincode" className="w-full border rounded-md px-3 py-2" />
        </div>

        {/* Row 4 - Radio Buttons */}
        <div className="sm:col-span-2">
          <label className="font-semibold mb-1 block">Preferred Delivery Method</label>
        ...
        <div>
          <label className="font-semibold mb-1 block">Products To Be Delivered?</label>
          <input type="date" className="w-full border rounded-md px-3 py-2" />
        </div>
        ...
        <div className="sm:col-span-2 mt-6">
          ...
          <p className="text-xs text-gray-500">(All measurements in inches)</p>
        </div>

        {/* Measurements */}
        {[
          ["Shoulder Width", "Bust"],
          ["Under Bust", "Blouse Length"],
          ["Armhole", "Sleeve Length"],
          ["Sleeve Circumference", "Neck Front Depth"],
          ["Neck Back Depth", "Waist Circumference"],
        ].map(([left, right], idx) => (
        ...
        <div>
          <label className="font-semibold mb-1 block">Sleeve Type</label>
          <select className="w-full border rounded-md px-3 py-2">
            <option>Cap</option>
            <option>Full</option>
            <option>3/4th</option>
        ...
        <div>
          <label className="font-semibold mb-1 block">Aari Work Style</label>
          <select className="w-full border rounded-md px-3 py-2">
        ...
        <div>
          <label className="font-semibold mb-1 block">Upload Reference Image</label>
...
export default AariMeasurement;
