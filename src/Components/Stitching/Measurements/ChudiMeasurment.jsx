          ...
          <div className="max-w-4xl mx-auto px-6 py-10 border border-green-300 rounded-md shadow-md bg-white">
            ...
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
              ...
              {[
                ...
                ["Under Bust", "Waist"],
                ["Hip", "Armhole"],
                ["Sleeve Length", "Elbow Circumference"],
                ["Wrist", "Chudi Length"],
                ["Wrist", "Kameez Length"],
              ...
              {[
                ["Waist", "Hip"],
                ["Thigh", "Knee Circumference"],
                ["Calf", "Ankle Circumference"],
                ["Bottom Length", "Rise / Crotch Depth"],
              ].map(([left, right], idx) => (
...
export default ChudiMeasurment;
