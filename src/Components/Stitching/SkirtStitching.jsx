...
import SkirtMeasurment from "./Measurements/SkirtMeasurment";

const skirtstyle = [
  "Flared Skirt with Crop Top",
  "Straight Skirt with Short Kurti",
  "Peplum Top with Skirt",
  "Frill or Ruffle Skirt Sets",
  "Layered Skirts with Designer Tops",
  "Kids’ Partywear Skirt & Top Sets",
];
      ...
      <div className="bg-white py-10 px-6 md:px-20 lg:px-20 relative">
        ...
        <div className="max-w-5xl">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Skirt & Top Stitching at Sree Shanmuga Textiles
          </h1>

          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">
              Elegance, style, and comfort — stitched to perfection
            </h2>
            <p className="text-gray-700 leading-relaxed">
              Skirt and top sets are a beautiful blend of modern charm and
              traditional elegance. Whether you're styling your child for a
              birthday or selecting an ethnic outfit for a festive occasion,
              Sree Shanmuga Textiles offers customized stitching services to
              bring your perfect outfit to life. Our team carefully crafts each
              set to match your design, measurements, and fabric choice —
              ensuring a flawless look and fit.
            </p>
          </div>

          <div className="mb-8">
            <h1 className="text-xl font-semibold mb-2">
              Why Choose Our Skirt & Top Stitching?
            </h1>
            <p className="text-gray-700 leading-8">
              Every skirt and top stitched by us is made with attention to
              detail, keeping comfort, fit, and fashion in focus. Our stitching
              services include custom neck patterns, sleeve styles, waistband
              types, and length preferences based on your needs. You can also
              opt for Aari work embroidery, lining options, and designer
              finishing — all at affordable prices.
            </p>
          </div>
        </div>
