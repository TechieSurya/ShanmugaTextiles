...
const umbrellastyle = [
  "Classic Umbrella Cut Frock",
  "Double-Layered Flare Frock",
  "Bow-Back Party Frock",
  "Puff Sleeve Umbrella Frock",
  "High-Low Hem Frock",
  "Tulle Layered Umbrella Gowns",
  "Ethnic Frock with Aari Work or Borders",
      ...
      <div className="bg-white py-10 px-6 md:px-20 lg:px-20 relative">
        ...
        <div className="max-w-5xl">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Umbrella Frock Stitching for Kids at Sree Shanmuga Textiles
          </h1>

          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">
              Where cuteness meets comfort — stitched to twirl
            </h2>
            <p className="text-gray-700 leading-relaxed">
              Umbrella frocks are every little girl’s favorite outfit — flowy,
              vibrant, and perfect for celebrations or everyday fun. At Sree
              Shanmuga Textiles, we offer beautifully tailored custom umbrella
              frock stitching for kids, designed to bring joy, color, and style
              to their wardrobe.
            </p>
          </div>
          ...
          <div className="mb-8">
            <h1 className="text-xl font-semibold mb-2">
              Why Choose Our Kids Frock Stitching?
            </h1>
            <p className="text-gray-700 leading-8">
              We know that every child is unique, and so are their fitting
              needs. That’s why we offer measurement-based tailoring for all
              frocks — ensuring they’re not just adorable, but also comfortable
              and easy to move in. Whether it’s for a birthday party, school
              function, or festive occasion, our frocks are stitched with care,
              premium-quality fabrics, and child-friendly detailing.
            </p>
          </div>
        </div>
        ...
        <div className="mt-5">
          <h2 className="text-xl md:text-2xl font-semibold mb-6">
            Types of Umbrella Designs We Stitch
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 mb-10">
            {umbrellastyle.map((type, items) => (
...
export default UmbrellaStitching;
