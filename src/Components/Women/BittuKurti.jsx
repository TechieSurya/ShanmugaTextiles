    ...
    const fetchProducts = async () => {
      try {
        const q = query(
          ...
          where("category", "==", "Maxi Dresses > Bittu Maxi") // exact match
        );
  ...
  return (
    <div className="px-6 py-6 font-family">
      <div className="mb-6 text-center">
        <h2 className="text-3xl font-bold mb-1">Maxi Dresses</h2>
        <h4 className="text-green-700 font-medium">Bittu Kurti</h4>
      </div>
