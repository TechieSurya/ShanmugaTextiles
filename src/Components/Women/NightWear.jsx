    ...
    const fetchProducts = async () => {
      try {
        const q = query(
          ...
          where("category", "==", "Night Wear > Night Wear") // exact match
        );
  ...
  return (
    <div className="px-6 py-6 font-family">
      <div className="mb-6 text-center">
        <h2 className="text-3xl font-bold mb-1">Night Wear</h2>
        <h4 className="text-green-700 font-medium">Night Dresses</h4>
      </div>
