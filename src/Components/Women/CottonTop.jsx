    ...
    const fetchProducts = async () => {
      try {
        const q = query(
          ...
          where("category", "==", "Tops & Tees > Cotton Top") // exact match
        );
  ...
  return (
    <div className="px-6 py-6 font-family">
      <div className="mb-6 text-center">
        <h2 className="text-3xl font-bold mb-1">Tops & Tees</h2>
        <h4 className="text-green-700 font-medium">Cotton Top</h4>
      </div>
