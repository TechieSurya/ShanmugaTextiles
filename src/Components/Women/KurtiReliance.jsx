    ...
    const fetchProducts = async () => {
      try {
        const q = query(
          ...
          where("category", "==", "Kurtis & Sets > Kurti Reliance Brand") // exact match
        );
  ...
  return (
    <div className="px-6 py-6 font-family">
      <div className="mb-6 text-center">
        ...
        <h4 className="text-green-700 font-medium">Kurtis Reliance Brand</h4>
      </div>
